...
import CustomLogo from "../public/csgulogo.png";
                    ...
                    <div className="text-center space-y-8 md:space-y-12">
                        <div className="flex flex-col items-center justify-center space-y-6 md:space-y-8">
                            <div className="relative">
                                <div className="absolute -inset-1 bg-gradient-to-r from-[#00964D] to-[#1E7A4D] opacity-75 blur-lg animate-pulse" />
                                <div className="relative w-26 h-20 md:w-26 md:h-20 overflow-hidden">
                                    <Image
                                        src={CustomLogo.src}
                                        alt="CS Logo"
                                        width={100}
                            ...
                            <h1 className="sm:text-5xl md:text-7xl lg:text-7xl font-bold tracking-tight bg-gradient-to-b from-[#53E140] to-[#2D7B23] bg-clip-text text-transparent px-4 uppercase">
                                IEEE Industry applications society
                            </h1>

                            <p className="text-lg sm:text-xl md:text-3xl text-[#53E140]/80 max-w-3xl mx-auto font-light px-4">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 pt-8 w-full px-4">
                                <Link href="https://docs.google.com/forms/d/e/1FAIpQLSeX_oAlWl9f9--JF3Dz5rJD-7NkD0_IUr2rGDUTHBq2TfzfPQ/viewform" passHref>
                                    <button className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-[#53E140] hover:bg-[#53E140] rounded-lg flex items-center justify-center space-x-3 transition-all duration-300 hover:scale-105 transform group">
                                ...
                                <Link href="https://www.computer.org/membership" passHref>
                                    <button className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-slate-800/80 hover:bg-slate-700 rounded-lg transition-all duration-300 hover:scale-105 transform border border-[#53E140]/30 hover:border-[#53E140] text-base md:text-lg backdrop-blur-sm text-white">
                                        Learn More
                                    </button>
                                </Link>
                            </div>
